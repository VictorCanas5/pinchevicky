			...
			<div class="container-fliud">
				<div class="wrapper row">
					...
					<div class="details col-md-6">
						...
						<p class="product-description">Para obtener este producto presiona el boton de comprar para que se genere tu orden y recojas el producto en el local de BZ shop</p>
